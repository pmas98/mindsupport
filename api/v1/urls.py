...
from api.v1.views import UserRegistrationView, UserLoginView, ModeratorRegistrationView, ThemesView, RoomsView, RoomUserView, RemoveUserRoomView, UserView, BlockUserView, GetAllMessagesView

urlpatterns = [
    path('register/', UserRegistrationView.as_view(), name='user_registration'),
    path('register/moderator/', ModeratorRegistrationView.as_view(), name='moderator_registration'),
