...
from api.v1.serializers import UserRegistrationSerializer, LoginSerializer, ModeradorRegistrationSerializer, TemaSerializer, RoomUserSerializer
...
class RoomUserView(APIView):
    ...
    def post(self, request):
        ...
        serializer = RoomUserSerializer(data=request.data, context={'usuario': usuario_id})
        serializer.is_valid(raise_exception=True)
        serializer.save()
